...
//		//User:        "root",
//		//Password:    "111111",
//		DataSource:  []string{"192.168.0.108:27017"},
//		DB:          "xv_app_log",
//		AuthDB:      "gm_menu",
//		ReplicaSet:  "",
//		MaxPoolSize: 100,
...
func (c *demoCollection) CollectionName() string {
...
func TestInsertMany(t *testing.T) {
	...
	_, err := store.InsertMany(context.TODO(), docs)
	if err != nil {
		t.Fatal(err)
	}
...
func TestCountEstimateDocuments2(t *testing.T) {
	resp, err := http.Get("http://lenovo.ipv6.hhh2000.top/")
